...
public class Typing: MonoBehaviour
{
    ...
    {
        string data = System.IO.File.ReadAllText(Application.dataPath+"/2.txt");
        string[] lines = data.Split(System.Environment.NewLine);
        return lines[currentDayNumber - releaseDayNumber];
    }
    ...
    void Update()
    {
        ...
        floatingText.transform.localPosition = new Vector3(floatingText.transform.localPosition.x,floatingText.transform.localPosition.y+(-11-floatingText.transform.localPosition.y)*4*Time.deltaTime,floatingText.transform.localPosition.z);
